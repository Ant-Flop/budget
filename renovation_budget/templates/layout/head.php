<head>
    ...
    <link rel="stylesheet" href="modal-windows/modal-window.css" type="text/css">
    <link rel="stylesheet" href="../../templates/layout/footer.css" type="text/css">
    <link rel="stylesheet" href="../../../templates/libs/font-awesome-4.7.0/css/font-awesome.min.css">
    <script src="../../../templates/libs/jquery-3.6.1/dist/jquery.min.js"></script>
    <title>Бюджет ремонтів ІТ</title>
</head>