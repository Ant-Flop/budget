...
const modalEditBudgetPlanOnClick = () => {
  editBudgetPlanState.id = editPlannedIndicatorState.plannedIndicatorId;
  modalGetBudgetPlanRequest();

  console.log(editPlannedIndicatorState.plannedIndicatorId);
