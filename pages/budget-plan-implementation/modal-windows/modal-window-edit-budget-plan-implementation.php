<div id='modal-window-edit-budget-plan-implementation' class='modal-window unselectable'>
    <div class='modal-window-content'>
        <span class='modal-close' onclick='modalEditBudgetPlanImplementationCloseOnClick()'>&times;</span>
        <div class='text-2'>Редагування планового показника</div>
        <div class='modal-window-set-sum__table'>
        <table id='modal-window-edit-budget-plan-implementation-table'>
            <thead>
                <tr>
                    <th></th>
                    <th>Січень</th>
        ...
        <div class='modal-button'>
            <button id='modal-button-sum-save' onclick='modalEditBudgetPlanImplementationSaveOnClick()'>Зберегти</button>
        </div>
    </div>
</div>