...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            <div class="main-header">
                <div class="main-header-title main-header-item text-1">Довідник служб бюджету</div>
            </div>
            <div class="main-content">
                <div class="above-table-bar unselectable">
                    <div class="add-button-table-bar">
                        <label>Додати службу</label><br />
                        <div class="above-table-bar-element">
                            <button class="above-table-add__button"
                                onclick='modalAddServiceOnClick()'>Додати</button>
                        </div>
                    </div>
        ...
        <?php require("modal-windows/modal-window-add-service.php") ?>
        <?php require("modal-windows/modal-window-edit-service.php") ?>
    </div>
    ...
    <script src="modal-windows/modal-window-add-service.js"></script>
    <script src="modal-windows/modal-window-edit-service.js"></script>
</body>
