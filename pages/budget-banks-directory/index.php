...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            <div class="main-header">
                <div class="main-header-title main-header-item text-1">Довідник банків</div>
            </div>
            <div class="main-content">
                <div class="above-table-bar unselectable">
                    <div class="add-button-table-bar">
                        <label>Додати банк</label><br />
                        <div class="above-table-bar-element">
                            <button class="above-table-add__button" onclick='modalAddBankOnClick()'>Додати</button>
                        </div>
                    </div>
        ...
        <?php require("modal-windows/modal-window-add-bank.php") ?>
        <?php require("modal-windows/modal-window-edit-bank.php") ?>
    </div>
    ...
    <script src="modal-windows/modal-window-add-bank.js"></script>
    <script src="modal-windows/modal-window-edit-bank.js"></script>
</body>
